...
public class ElbowStates {
    ...
    public static void groundCoral() {
        scheduleIfNotRunning(groundMove(config::getGroundCoralIntake, "Elbow.groundCoral"));
    }
    ...
    public static void L2CoralPrep() {
        scheduleIfNotRunning(
                move(config::getL2Coral, config::getExL2Coral, "Elbow.L2CoralPrep")
                        .onlyWhile(ElevatorStates.isL2Coral));
    }
    ...
    public static void L3CoralPrep() {
        scheduleIfNotRunning(
                move(config::getL3Coral, config::getExL3Coral, "Elbow.L3CoralPrep")
                        .onlyWhile(ElevatorStates.isL3Coral));
    }
    ...
    public static void L4CoralPrep() {
        scheduleIfNotRunning(
                move(config::getL4Coral, config::getExL4Coral, "Elbow.L4CoralPrep")
                        .onlyWhile(ElevatorStates.isL4Coral));
    }
