...
public class IntakeStates {
    ...
    public static final Trigger hasCoral = hasGamePiece.and(intake.aboveVelocityRPM(() -> 0, () -> 0));
    public static final Trigger hasAlgae = hasGamePiece.and(intake.belowVelocityRPM(() -> 0, () -> 0));
